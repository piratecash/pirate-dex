...
import PiratecashGatewayDepositRequest from "./PiratecashGatewayDepositRequest";
...
class PiratecashGateway extends React.Component {
    constructor(props) {
        super();
    ...
    render() {
        ...
        let supportUrl = "https://t.me/PirateCash_ENG";
                ...
                {!coin ? null : (
                    <div>
                        <div style={{marginBottom: 15}}>
                            ...
                            <div>
                                <Translate content="gateway.piratecash.support_block" />
                                <br />
                                <br />
                                <a
                                    href={supportUrl}
...
export default connect(PiratecashGateway, {
    listenTo() {
